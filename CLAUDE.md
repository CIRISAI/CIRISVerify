...
| Crate | Status | Notes |
|-------|--------|-------|
| `ciris-keyring` | Phase 2 | HardwareSigner trait, SoftwareSigner impl, Android Keystore (AES-256-GCM key wrapping) |
...
| `bindings/python` | Released | ciris-verify 0.8.0 on PyPI with platform wheels |
...
**185+ tests passing** across all crates.
